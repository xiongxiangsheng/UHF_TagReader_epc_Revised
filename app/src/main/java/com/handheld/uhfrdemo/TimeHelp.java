...
public class TimeHelp {
     ...
     * @param minute    分钟
     */
    public TimeHelp(int hour, int minute) {
     ...
     * @param second    秒
     */
    public TimeHelp(int hour, int minute, int second) {
     ...
     * @param second    秒
     */
    public TimeHelp(int day, int hour, int minute, int second) {
     ...
     * @param time      字符串格式的时间
     */
    public TimeHelp(String time, String timeSeparator) {
     ...
     * @return          运算后的时间
     */
    public TimeHelp addTime(TimeHelp time) {
        TimeHelp result = new TimeHelp();
        int up = 0;     // 进位标志
     ...
     * @return          运算后的时间
     */
    public TimeHelp subtractTime(TimeHelp time) {
        TimeHelp result = new TimeHelp();
        int down = 0;       // 退位标志
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final TimeHelp other = (TimeHelp) obj;
    ...
    public static String getYearMonthDayHourMinuteSecond(long timeMillis) {
        ...
        String t = format.format(new Date(timeMillis));
        return t;
        */
        ///*
